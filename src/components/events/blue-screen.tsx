...
export default function BlueScreen() {
    ...
    useEffect(() => {
        ...
        }, 35); // Faster progress to match 4s reboot

        return () => clearInterval(interval);
    }, []);

    return (
        <div className="fixed inset-0 bg-[#0000AA] text-white font-mono flex flex-col items-center justify-center z-[9999] animate-in fade-in">
